...
public class Currency extends IntegerSerialIdentifier {
    public static final String ENTITY_NAME = "Moneda";
    ...
    public static Currency findDollar() {
        String dollarCode = "USD";
        PanacheQuery<Currency> query = find("isoStringCode", dollarCode);
        return query.firstResultOptional().orElseThrow(() -> EntityNotFound.create(ENTITY_NAME, dollarCode));
    }
